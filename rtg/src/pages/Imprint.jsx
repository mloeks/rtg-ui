...
const Imprint = () => (
  <Page className="ImprintPage">
    <BigPicture className="ImprintPage__heading" img={headingImg} large>
    ...
    <section className="ImprintPage__content">
      ...
      <p>
        ...
        Ausnahmen sind freiwillige Spenden der Teilnehmer.
        <br />
      ...
      <p>
        ...
        , urheberrechtlich geschützt) und von Real Madrid(
        <a href="http://www.realmadrid.com/" target="_blank" rel="noopener noreferrer">
          © Real Madrid CF
        </a>
        , urheberrechtlich geschützt) gestaltet.
      </p>
      <p>
